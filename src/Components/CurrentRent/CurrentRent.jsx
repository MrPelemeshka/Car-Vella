...
class CurrentRent extends React.Component {
    render() {
        return (
            <section class="header2 cid-sCARb58lSd" id="header2-1i" data-component="currentrent">
    ...
    <div class="container">
        <div class="mbr-row mbr-jc-c">
            <div class="mbr-col-lg-8 mbr-col-sm-12 mbr-col-md-12 mbr-flex mbr-column">
                ...
                <div class="mbr-section-btn align-center"><NavLink class="btn btn-md btn-primary display-4" to="/RentPay">Закончить аренду</NavLink></div>
                <div class="mbr-pt-4">
