...
reasons = {
    ...
    ErrorsNames.UnsupportedPromoConditionError.value: 'Unsupported promo type',

    ErrorsNames.InvalidCarIDError.value: 'Invalid car ID',
    ErrorsNames.AllCarsWithThisIDAreRentedError.value: 'All cars with this ID are rented',
    ErrorsNames.AlreadyRentError.value: 'User already rent something',
    ErrorsNames.NoRentError.value: 'User does not rent anything',
    ErrorsNames.InvalidBicycleIDError.value: 'Invalid bicycle ID',
    ErrorsNames.AllBicyclesWithThisIDAreRentedError.value: 'All bicycles with this ID are rented',
