...
class BicyclesInventory(models.Model):
    ...
    is_rented_now = models.IntegerField(blank=True, null=True)
...
class DjangoSession(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('id', 'session_key'),)


class DriverValidationResult(models.Model):
    drivers_validation_id = models.IntegerField()
    ...
    class Meta:
        ...
        unique_together = (('id', 'drivers_validation_id'),)


class DriversValidation(models.Model):
    user_id = models.IntegerField()
    validation_manager_id = models.IntegerField(blank=True, null=True)
...
class Promocodes(models.Model):
    ...
    activations_count = models.IntegerField()
    ...
    promo_condition = models.IntegerField()
...
class PromocodesActivations(models.Model):
    promocodes = models.OneToOneField(Promocodes, models.DO_NOTHING, primary_key=True)
    ...
    class Meta:
        ...
        unique_together = (('promocodes', 'users'),)


class QaChat(models.Model):
    ticket = models.ForeignKey('QaTickets', models.DO_NOTHING)
...
class Users(models.Model):
    ...
    is_validated_driver = models.IntegerField()
    email = models.CharField(max_length=128)
    is_email_confirmed = models.IntegerField()
    profile_photo_path = models.CharField(max_length=256, blank=True, null=True)
    is_user_blocked = models.IntegerField()
